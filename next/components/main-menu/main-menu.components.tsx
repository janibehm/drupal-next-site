  ...
  return (
    <NavigationMenu.Root
      ...
      className={clsx(
        ...
        isOpen && "border-t bg-midnight lg:border",
        isOpen &&
...
export function MenuList({ children, level }) {
  return (
    <NavigationMenu.List
      className={clsx(
        "fixed inset-0 top-[72px] overflow-scroll border-b border-l border-r border-white bg-midnight lg:absolute lg:top-0 lg:w-[min(33.334vw,384px)] lg:overflow-visible",
        level === 0 &&
          "z-10 h-full lg:left-0 lg:z-auto lg:border-primary-50 lg:bg-primary-600",
